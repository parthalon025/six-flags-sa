...
This project is indexed by GitNexus as **six-flags-sa** (4799 symbols, 11976 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
