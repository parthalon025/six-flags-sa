...
up the instant it comes back on. Party creation and joining are rate limited per address,
relay traffic per party — per party rather than per address because a park is one enormous
NAT, and metering the address would meter the venue.
