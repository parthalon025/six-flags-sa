...
export const TEST_ESTATE = {
  ...
  'test/builder/delivery-seed-export.mjs': ['test:builder'],
  ...
  'test/scripts/official-research-pr.test.mjs': ['ci-gate'],
  'test/scripts/official-page-via.test.mjs': ['test:builder'],
  ...
  'test/scripts/official-research-workflow.test.mjs': ['ci-gate'],
  ...
  'test/scripts/compare-cert-freshness.test.mjs': ['ci-gate'],
  'test/scripts/integrate-test-estate.test.mjs': ['ci-gate'],
  ...
  'test/scripts/venue-builder-guide.test.mjs': ['test:builder'],
