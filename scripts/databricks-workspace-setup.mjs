 ...
 * Decisions: docs/adr/0010-databricks-ops-free-tier.md
 */
...
0. Read first (do not relitigate)
   docs/adr/0010-databricks-ops-free-tier.md
...
5. Optional: Databricks App (steward UI / Lakebase)
   See databricks/apps/README.md — only after ADR-0010 trigger

6. CI (GitHub secrets)
   DATABRICKS_HOST, DATABRICKS_TOKEN (service principal)

Docs: docs/guide/databricks.md
ADR:   docs/adr/0008-databricks-back-office.md
       docs/adr/0010-databricks-ops-free-tier.md
`;
