...
This project is indexed by GitNexus as **six-flags-sa** (4696 symbols, 11704 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
