...
This project is indexed by GitNexus as **six-flags-sa** (4410 symbols, 11062 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
