...
This project is indexed by GitNexus as **six-flags-sa** (4369 symbols, 11020 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
