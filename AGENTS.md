...
This project is indexed by GitNexus as **six-flags-sa** (3568 symbols, 8778 relationships, 299 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
