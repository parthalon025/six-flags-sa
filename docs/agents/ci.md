...
| `../official-research-pr.mjs` | CLI → `composeOfficialResearchPrBody()` (`scripts/lib/official-research-pr.mjs`) | `sync-official-research.yml` — draft PR when caches change |
