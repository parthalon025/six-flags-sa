...
| `../lib/app-test-origin.mjs` | `appOrigin()`, `reserveAppPort()`, `probeAppHealth()`, `watchOriginHealth()` | Less-contended default port (3118), ephemeral reservation, and health probes for UI validation |
