...
- **`docs/adr/`** — numbered ADRs (`0001-slug.md`, …) that touch the area you're about to work in. One number, one ADR — `node scripts/ci/adr-numbers.mjs` gates that and prints what to do when two files claim a number.
