...
- Every **Member** sees the same **Place** name (or the same last known location of that **Member** at that **Place**) for a given **Location**; **Location** plus **Venue** slots decide it — not a check-in, not each phone guessing
