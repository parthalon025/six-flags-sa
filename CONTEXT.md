...
**Skin**:
A **Profile**-owned restyle of how the **World** map is painted, not where **Places** sit. Earned as a **Side Quest** prize (private unlock, then share). Not park truth.
_Avoid_: Theme (Trail / Park Midnight are Palettes); map pack; party theme; Map skin

**Custom map**:
Extra drawing a **Skin** may attach on the OSM base — replace or overlay. **Places** stay on their lat/lng. Not **Overlay**.
_Avoid_: Overlay; map pack; tileset
