...
/* The retiring SVG adapter (ADR-0019 clause 3, slice h11).
   ==========================================================================
   Everything below is the renderer this file *was* when it was ParkMap.jsx,
   moved here unchanged. ADR-0019 makes MapLibre the one map view and retires
   this one; ParkMap.jsx is now that view, and delegates here only through the
   escape hatch docs/train-h-seams.md names — "the SVG adapter stays behind
   this interface until the MapLibre one passes the gate". Two things still
   hold the hatch open, and both are named in ParkMap.jsx: the perf gate is
   slice h15, and the browser suites still assert on `svg.mapSvg`.

   Nothing new should be built in here. A fix that has to land in the shipped
   map lands here *and* in the ported path, or the two renderers drift and the
   ...
   this OSM base. ParkMapSvg applies the camera and hidden layers; CustomMapLayer
...
export default memo(ParkMapSvg);
