...
await check('kings-island passes buildable factory stages including full truth certification', async () => {
  ...
  assert.equal(certify.status, 'pass', 'map cert is complete after park_map_research');
