...
await check('cedar-point republishes its committed bundle byte-for-byte with the aerial claim live', async () => {
  ...
  /* 427, not 428, since commit a065a0a rebuilt cedar-point from current OSM.
     That rebuild is the ground truth this test reproduces. It removed four
     places and added three: two key rotations (ticket 25), one park rename,
     and Snake River Falls — closed permanently Sept 2024 (ticket 30). */
