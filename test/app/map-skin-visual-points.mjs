...
/* Raw PNG bytes are enough here: two Skins at the same point and viewport
   differ iff the encoded screenshots differ, and hashing bytes skips a
   pixel-decode dependency. */
