...
//  The sha has one owner: scripts/lib/train-plan.mjs. This file and the
//  workflow are both consumers, and the pin assertion below keeps the
//  workflow's literal honest against it.
{
  let baselineOk = true;
  try {
