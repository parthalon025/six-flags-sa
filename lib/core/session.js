...
export function createSession({
  ...
  return {
    ...
    selfId,
    role,
    // Who is serving this party right now. The creator knows it immediately;
    // a joiner adopts it from WELCOME. WebRTC's client path addresses its first
    // offer to this id and falls back to the broadcast address without it,
    // which costs every peer in the party one wasted signaling round.
    hostId,
  };
}
